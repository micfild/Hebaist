...
<body>
	...
	<div id="backgound">
        ...
        <!-- /Username -->
				...
				<input class="inpt-email rounded inpt" onkeyup="MyFunc(this)" type="text" name="email" placeholder="exemple@domaine.com" value="" maxlength="25">
				<!-- /email -->
        ...
        <!-- /Checkbox conditions -->
			...
			<a href="index.html"> <button type="button" class="bt-valide" id="valide-inscription">✔
			</button></a>
			<!-- /Button valide -->
